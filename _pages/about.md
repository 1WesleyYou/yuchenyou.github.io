...
<style>
	...
	@media (min-width: 868px){
		.home-featured .archive__item-teaser img { max-height: 300px; object-fit: cover; }
		/* allocate more width to both columns */
		.home-featured .archive__item { gap: 1.5rem; }
		.home-featured .archive__item-teaser { flex: 0 0 48%; }
		.home-featured .archive__item-body { flex: 1; max-width: none; }
	}
